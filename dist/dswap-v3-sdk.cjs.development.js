...
var IMulticall = _interopDefault(require('@dragonswap/v2-periphery/artifacts/contracts/interfaces/IMulticall.sol/IMulticall.json'));
var INonfungiblePositionManager = _interopDefault(require('@dragonswap/v2-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'));
var ISelfPermit = _interopDefault(require('@dragonswap/v2-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json'));
var IPeripheryPaymentsWithFee = _interopDefault(require('@dragonswap/v2-periphery/artifacts/contracts/interfaces/IPeripheryPaymentsWithFee.sol/IPeripheryPaymentsWithFee.json'));
var IQuoter = _interopDefault(require('@dragonswap/v2-periphery/artifacts/contracts/lens/Quoter.sol/Quoter.json'));
var IQuoterV2 = _interopDefault(require('@dragonswap/swap-router-contracts/artifacts/contracts/lens/QuoterV2.sol/QuoterV2.json'));
var IUniswapV3Staker = _interopDefault(require('@dragonswap/v2-staker/artifacts/contracts/DragonswapV2Staker.sol/DragonswapV2Staker.json'));
var ISwapRouter = _interopDefault(require('@dragonswap/v2-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'));
...
var _TICK_SPACINGS;
var FACTORY_ADDRESS = '0x179D9a5592Bc77050796F7be28058c51cA575df4';
...
function multiplyIn256(x, y) {
  ...
  return JSBI.bitwiseAnd(product, dswapSdkCore.MaxUint256);
}
function addIn256(x, y) {
  var sum = JSBI.add(x, y);
  return JSBI.bitwiseAnd(sum, dswapSdkCore.MaxUint256);
}
...
function mostSignificantBit(x) {
  ...
  !JSBI.lessThanOrEqual(x, dswapSdkCore.MaxUint256) ?  invariant(false, 'MAX')  : void 0;
  var msb = 0;
...
var TickMath = /*#__PURE__*/function () {
  ...
  TickMath.getSqrtRatioAtTick = function getSqrtRatioAtTick(tick) {
    ...
    if (tick > 0) ratio = JSBI.divide(dswapSdkCore.MaxUint256, ratio);
    // back to Q96
...
function encodeSqrtRatioX96(amount1, amount0) {
  ...
  return dswapSdkCore.sqrt(ratioX192);
}
...
function tickToPrice(baseToken, quoteToken, tick) {
  ...
  return baseToken.sortsBefore(quoteToken) ? new dswapSdkCore.Price(baseToken, quoteToken, Q192, ratioX192) : new dswapSdkCore.Price(baseToken, quoteToken, ratioX192, Q192);
}
/**
...
var Pool = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            return _context.abrupt("return", [dswapSdkCore.CurrencyAmount.fromRawAmount(outputToken, JSBI.multiply(outputAmount, NEGATIVE_ONE)), new Pool(this.token0, this.token1, this.fee, sqrtRatioX96, liquidity, tickCurrent, this.tickDataProvider)]);
          case 11:
          case "end":
            return _context.stop();
        }
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            return _context2.abrupt("return", [dswapSdkCore.CurrencyAmount.fromRawAmount(inputToken, inputAmount), new Pool(this.token0, this.token1, this.fee, sqrtRatioX96, liquidity, tickCurrent, this.tickDataProvider)]);
          case 11:
          case "end":
            return _context2.stop();
        }
  ...
  return _createClass(Pool, [{
    ...
    get: function get() {
      ...
      return (_this$_token0Price = this._token0Price) != null ? _this$_token0Price : this._token0Price = new dswapSdkCore.Price(this.token0, this.token1, Q192, JSBI.multiply(this.sqrtRatioX96, this.sqrtRatioX96));
    }
    /**
    ...
    get: function get() {
      ...
      return (_this$_token1Price = this._token1Price) != null ? _this$_token1Price : this._token1Price = new dswapSdkCore.Price(this.token1, this.token0, JSBI.multiply(this.sqrtRatioX96, this.sqrtRatioX96), Q192);
    }
  }, {
    key: "chainId",
    get: function get() {
...
var Position = /*#__PURE__*/function () {
  ...
  _proto.ratiosAfterSlippage = function ratiosAfterSlippage(slippageTolerance) {
    var priceLower = this.pool.token0Price.asFraction.multiply(new dswapSdkCore.Percent(1).subtract(slippageTolerance));
  ...
  Position.fromAmount0 = function fromAmount0(_ref3) {
    ...
    return Position.fromAmounts({
      ...
      tickUpper: tickUpper,
      amount0: amount0,
      amount1: dswapSdkCore.MaxUint256,
  ...
  Position.fromAmount1 = function fromAmount1(_ref4) {
    ...
    return Position.fromAmounts({
      ...
      tickLower: tickLower,
      tickUpper: tickUpper,
      amount0: dswapSdkCore.MaxUint256,
      amount1: amount1,
  ...
  return _createClass(Position, [{
    ...
    get: function get() {
      if (this._token0Amount === null) {
        if (this.pool.tickCurrent < this.tickLower) {
          this._token0Amount = dswapSdkCore.CurrencyAmount.fromRawAmount(this.pool.token0, SqrtPriceMath.getAmount0Delta(TickMath.getSqrtRatioAtTick(this.tickLower), TickMath.getSqrtRatioAtTick(this.tickUpper), this.liquidity, false));
        } else if (this.pool.tickCurrent < this.tickUpper) {
          this._token0Amount = dswapSdkCore.CurrencyAmount.fromRawAmount(this.pool.token0, SqrtPriceMath.getAmount0Delta(this.pool.sqrtRatioX96, TickMath.getSqrtRatioAtTick(this.tickUpper), this.liquidity, false));
        } else {
          this._token0Amount = dswapSdkCore.CurrencyAmount.fromRawAmount(this.pool.token0, ZERO);
        }
      }
    ...
    get: function get() {
      if (this._token1Amount === null) {
        if (this.pool.tickCurrent < this.tickLower) {
          this._token1Amount = dswapSdkCore.CurrencyAmount.fromRawAmount(this.pool.token1, ZERO);
        } else if (this.pool.tickCurrent < this.tickUpper) {
          this._token1Amount = dswapSdkCore.CurrencyAmount.fromRawAmount(this.pool.token1, SqrtPriceMath.getAmount1Delta(TickMath.getSqrtRatioAtTick(this.tickLower), this.pool.sqrtRatioX96, this.liquidity, false));
        } else {
          this._token1Amount = dswapSdkCore.CurrencyAmount.fromRawAmount(this.pool.token1, SqrtPriceMath.getAmount1Delta(TickMath.getSqrtRatioAtTick(this.tickLower), TickMath.getSqrtRatioAtTick(this.tickUpper), this.liquidity, false));
        }
      }
  ...
  function () {
    var _exactIn = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(route, amountIn) {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", Trade.fromRoute(route, amountIn, dswapSdkCore.TradeType.EXACT_INPUT));
          case 1:
          case "end":
            return _context.stop();
        }
  ...
  function () {
    var _exactOut = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(route, amountOut) {
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt("return", Trade.fromRoute(route, amountOut, dswapSdkCore.TradeType.EXACT_OUTPUT));
          case 1:
          case "end":
            return _context2.stop();
        }
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 29:
            ...
            break;
          case 32:
            inputAmount = dswapSdkCore.CurrencyAmount.fromFractionalAmount(route.input, amounts[0].numerator, amounts[0].denominator);
            outputAmount = dswapSdkCore.CurrencyAmount.fromFractionalAmount(route.output, amount.numerator, amount.denominator);
          case 34:
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 25:
            !amount.currency.equals(route.output) ?  invariant(false, 'OUTPUT')  : void 0;
            outputAmount = dswapSdkCore.CurrencyAmount.fromFractionalAmount(route.output, amount.numerator, amount.denominator);
            amounts[amounts.length - 1] = dswapSdkCore.CurrencyAmount.fromFractionalAmount(route.output.wrapped, amount.numerator, amount.denominator);
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 28:
            ...
            _context5.t1 = dswapSdkCore.sortedInsert;
            _context5.t2 = bestTrades;
            _context5.next = 33;
            return Trade.fromRoute(new Route([].concat(currentPools, [pool]), currencyAmountIn.currency, currencyOut), currencyAmountIn, dswapSdkCore.TradeType.EXACT_INPUT);
          case 33:
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          ...
          case 28:
            ...
            _context6.t1 = dswapSdkCore.sortedInsert;
            _context6.t2 = bestTrades;
            _context6.next = 33;
            return Trade.fromRoute(new Route([pool].concat(currentPools), currencyIn, currencyAmountOut.currency), currencyAmountOut, dswapSdkCore.TradeType.EXACT_OUTPUT);
          case 33:
...
var Payments = /*#__PURE__*/function () {
  ...
  Payments.encodeUnwrapWETH9 = function encodeUnwrapWETH9(amountMinimum, recipient, feeOptions) {
    recipient = dswapSdkCore.validateAndParseAddress(recipient);
    if (!!feeOptions) {
      var feeBips = this.encodeFeeBips(feeOptions.fee);
      var feeRecipient = dswapSdkCore.validateAndParseAddress(feeOptions.recipient);
      return Payments.INTERFACE.encodeFunctionData('unwrapWSEIWithFee', [toHex(amountMinimum), recipient, feeBips, feeRecipient]);
    } else {
      return Payments.INTERFACE.encodeFunctionData('unwrapWSEI', [toHex(amountMinimum), recipient]);
    }
  };
  ...
  Payments.encodeRefundETH = function encodeRefundETH() {
    return Payments.INTERFACE.encodeFunctionData('refundSEI');
  };
  return Payments;
}();
...
var NonfungiblePositionManager = /*#__PURE__*/function () {
  ...
  NonfungiblePositionManager.addCallParameters = function addCallParameters(position, options) {
    ...
    // mint
    if (isMint(options)) {
      var recipient = dswapSdkCore.validateAndParseAddress(options.recipient);
  ...
  NonfungiblePositionManager.removeCallParameters = function removeCallParameters(position, options) {
    ...
    if (options.permit) {
      calldatas.push(NonfungiblePositionManager.INTERFACE.encodeFunctionData('permit', [dswapSdkCore.validateAndParseAddress(options.permit.spender), tokenId, toHex(options.permit.deadline), options.permit.v, options.permit.r, options.permit.s]));
    }
    // remove liquidity
    ...
    calldatas.push.apply(calldatas, NonfungiblePositionManager.encodeCollect(_extends({
      ...
      expectedCurrencyOwed0: expectedCurrencyOwed0.add(dswapSdkCore.CurrencyAmount.fromRawAmount(expectedCurrencyOwed0.currency, amount0Min)),
      expectedCurrencyOwed1: expectedCurrencyOwed1.add(dswapSdkCore.CurrencyAmount.fromRawAmount(expectedCurrencyOwed1.currency, amount1Min))
    }, rest)));
  ...
  NonfungiblePositionManager.safeTransferFromParameters = function safeTransferFromParameters(options) {
    var recipient = dswapSdkCore.validateAndParseAddress(options.recipient);
    var sender = dswapSdkCore.validateAndParseAddress(options.sender);
    var calldata;
    if (options.data) {
...
var SwapQuoter = /*#__PURE__*/function () {
  ...
  SwapQuoter.quoteCallParameters = function quoteCallParameters(route, amount, tradeType, options) {
    ...
    if (singleHop) {
      ...
      var v2QuoteParams = _extends({}, baseQuoteParams, tradeType == dswapSdkCore.TradeType.EXACT_INPUT ? {
      ...
      var tradeTypeFunctionName = tradeType === dswapSdkCore.TradeType.EXACT_INPUT ? 'quoteExactInputSingle' : 'quoteExactOutputSingle';
      ...
      var path = encodeRouteToPath(route, tradeType === dswapSdkCore.TradeType.EXACT_OUTPUT);
      var _tradeTypeFunctionName = tradeType === dswapSdkCore.TradeType.EXACT_INPUT ? 'quoteExactInput' : 'quoteExactOutput';
...
var Staker = /*#__PURE__*/function () {
  ...
  Staker.withdrawToken = function withdrawToken(incentiveKeys, withdrawOptions) {
    ...
    var owner = dswapSdkCore.validateAndParseAddress(withdrawOptions.owner);
  ...
  Staker._encodeIncentiveKey = function _encodeIncentiveKey(incentiveKey) {
    ...
    var refundee = dswapSdkCore.validateAndParseAddress(incentiveKey.refundee);
    return {
...
var SwapRouter = /*#__PURE__*/function () {
  ...
  SwapRouter.swapCallParameters = function swapCallParameters(trades, options) {
    ...
    var calldatas = [];
    var ZERO_IN = dswapSdkCore.CurrencyAmount.fromRawAmount(trades[0].inputAmount.currency, 0);
    var ZERO_OUT = dswapSdkCore.CurrencyAmount.fromRawAmount(trades[0].outputAmount.currency, 0);
    var totalAmountOut = trades.reduce(function (sum, trade) {
      return sum.add(trade.minimumAmountOut(options.slippageTolerance));
    }, ZERO_OUT);
    // flag for whether a refund needs to happen
    var mustRefund = sampleTrade.inputAmount.currency.isNative && sampleTrade.tradeType === dswapSdkCore.TradeType.EXACT_OUTPUT;
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(trades), _step; !(_step = _iterator()).done;) {
      ...
      for (var _iterator2 = _createForOfIteratorHelperLoose(trade.swaps), _step2; !(_step2 = _iterator2()).done;) {
        ...
        if (singleHop) {
          ...
          var path = encodeRouteToPath(route, trade.tradeType === dswapSdkCore.TradeType.EXACT_OUTPUT);
          if (trade.tradeType === dswapSdkCore.TradeType.EXACT_INPUT) {
...
//# sourceMappingURL=dswap-v3-sdk.cjs.development.js.map
